// HTML Markers from https://r3f.docs.pmnd.rs/getting-started/examples
  ...
  */
  ...
  return (
    <group rotation={[-Math.PI / 2, 0, Math.PI]} {...props} dispose={null}>
      ...
      >
        <Marker rotation={[0, Math.PI / 2, -3.14]} position={[0.3, -1.15, 0.45 + Z_OFFSET]}>
          {/* Anything in here is regular HTML, these markers are from font-awesome */}
          <FaMapMarkerAlt style={{ color: "orange" }} />
        </Marker>

        <group rotation={[-0, -0, Math.PI]} position={[0.3, -1.05, 0.65 + Z_OFFSET]}>
        ...
        <group position={[0, 0, 1.3 + Z_OFFSET]} rotation={[0, 0, Math.PI]}>
          <Marker rotation={[0, Math.PI / 2, Math.PI / 2]}>
            <div
              style={{
                position: "absolute",
